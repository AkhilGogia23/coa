...
//        this.downloadService=downloadService;
    ...
    @GetMapping("/download/{lotNumber}")
    public ResponseEntity<Void> downloadPdf(@PathVariable String lotNumber) {

        String presignedUrl = snowflakeService.getPresignedPdfUrl(lotNumber);
